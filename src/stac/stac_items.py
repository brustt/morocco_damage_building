...
def get_items(type_item: str) -> None:
    ...
    save_pickle(mapping_columns, make_path("mapping_columns_stac_collection.pkl", raw_dir_path, type_item))
...
class StaticStacReader:
    ...
    def download_items_threaded(self, hrefs: List[str]) -> Any: # add Generator type - extract from class
